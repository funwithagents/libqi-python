...
LD_LIBRARY_PATH=$PWD/build/linux-x86_64-gcc-release/lib/ auditwheel repair --strip --plat manylinux_2_34_x86_64 dist/qi-3.1.6-cp313-cp313-linux_x86_64.whl -w ./dist/fixed/
